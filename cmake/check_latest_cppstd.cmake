...
macro(_enable_libcxx_for_clang)
  ...
  if(CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
    ...
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -stdlib=libc++ -L${compiler_root}/lib -L${compiler_root}/lib/c++ -Wno-unused-command-line-argument")

    if(NOT WIN32)
      set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wl,-rpath,${compiler_root}/lib -Wl,-rpath,${compiler_root}/lib/c++")
    endif()
  endif()
endmacro()
