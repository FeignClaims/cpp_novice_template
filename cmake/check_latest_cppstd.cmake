...
macro(_enable_libcxx_for_clang)
  ...
  if(CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
    ...
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -stdlib=libc++ -L${compiler_root}/lib -Wno-unused-command-line-argument")
    if(NOT WIN32)
      set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wl,-rpath,${compiler_root}/lib")
    endif()
  endif()
endmacro()
